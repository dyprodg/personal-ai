  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-6 text-center">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-violet-600 text-transparent bg-clip-text">
          Personal AI
        </h1>
        <p className="text-xl mb-10 text-gray-600 max-w-lg mx-auto">
          Your intelligent companion for productivity and creativity, powered by{" "}
          <span className="text-blue-600 font-semibold">Dyprodg.</span>
        </p>
